          ...
          <div className="md:col-span-7 p-6 sm:p-10 md:p-8 lg:p-14 flex flex-col justify-center bg-white/90">
            <div className="space-y-6 max-w-md w-full mx-auto">
              ...
              <button
                ...
                className="google-login-btn group relative w-full flex items-center justify-center gap-3 px-5 py-3.5 rounded-xl font-bold text-sm transition-all duration-300 active:scale-[0.98] cursor-pointer"
              >
                <span className="flex items-center justify-center w-5 h-5 transition-transform duration-300 group-hover:scale-110">
                ...
                <span className="font-bold tracking-wide">Verify with Google</span>
              </button>
            </div>
          </div>
        </div>
